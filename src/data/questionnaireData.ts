...
export const questionnaire: QuestionnaireSection[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'microphoneBrands',
        text: 'Preferred MICROPHONE brands? (Select multiple if flexible)',
        type: 'multiple-choice',
        options: [
          { label: 'Shure (Industry Standard)', value: 'Shure' },
          { label: 'Sennheiser', value: 'Sennheiser' },
          { label: 'Audio-Technica', value: 'Audio-Technica' },
          { label: 'Biamp (Parlé Ceiling/Table Mics)', value: 'Biamp' },
          { label: 'ClearOne', value: 'ClearOne' },
      ...
      {
        id: 'dspAmplifierBrands',
        text: 'Preferred DSP & AMPLIFIER brands? (Select multiple if flexible)',
        type: 'multiple-choice',
        options: [
          { label: 'QSC (Q-SYS Ecosystem)', value: 'QSC' },
          { label: 'Biamp (Tesira/Devio)', value: 'Biamp' },
          { label: 'Shure (IntelliMix)', value: 'Shure' },
          { label: 'BSS (Soundweb London)', value: 'BSS' },
          { label: 'Yamaha (MTX/MRX)', value: 'Yamaha' },
          { label: 'Extron (DMP/XPA)', value: 'Extron' },
          { label: 'Crestron (Avia)', value: 'Crestron' },
        ],
      },
      {
        id: 'bgmPaSystem',
      ...
      {
        id: 'speakerBrands',
        text: 'Preferred SPEAKER brands? (Select multiple if flexible)',
        type: 'multiple-choice',
        options: [
          { label: 'QSC', value: 'QSC' },
          { label: 'JBL Professional', value: 'JBL' },
          { label: 'Biamp (Desono, Community)', value: 'Biamp' },
          { label: 'Shure', value: 'Shure' },
          { label: 'Bose Professional', value: 'Bose' },
          { label: 'Yamaha', value: 'Yamaha' },
