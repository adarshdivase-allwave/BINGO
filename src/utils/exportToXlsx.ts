...
import allwaveLogo from '../assets/allwave_logo.png';
import psniLogo from '../assets/psni_avixa_logo.png';
...
async function createSheetHeader(workbook: ExcelJS.Workbook, sheet: ExcelJS.Worksheet, branding: BrandingSettings, ranges: HeaderRanges) {
    ...
    // Primary Logo (Left)
    // Always use All-Wave logo
    await addImageToCell(workbook, sheet, allwaveLogo, leftStartCell, 90);

    // Secondary Logo (Right)
    // Always use PSNI/AVIXA logo
    await addImageToCell(workbook, sheet, psniLogo, rightStartCell, 90);
}
